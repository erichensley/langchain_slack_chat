...
def create_custom_images(model_id: str, parameters: Dict[str, Dict[str, str]]):
    ...
    input_parameters = {}
    schema = {'prompt': 'string', 'num_inference_steps': 'integer', 'guidance_scale': 'number', 'prior_cf_scale': 'integer', 'scheduler': 'string', 'refine': 'string', 'high_noise_frac': 'number', 'refine_steps': 'integer'}
